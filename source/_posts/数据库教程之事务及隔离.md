...
toc: true
abbrlink: 61605
top_img: 'https://i.loli.net/2020/06/26/HEOj2NlqBytd5Zh.jpg'
cover: 'https://i.loli.net/2020/06/26/HEOj2NlqBytd5Zh.jpg'
categories: 数据库教程
tags:
  - 事务
  - 隔离
...
{% meting "4860404736" "netease" "song" "theme:#FF4081" "mode:circulation" "mutex:true" "listmaxheight:340px" "preload:auto"  %}
...
> 对于多条SQL语句，想要使用事务，必须手动启用，使用`BEGIN`开启一个事务，使用`COMMIT`提交一个事务，这种事务被称为**显式事务**。
>
